...
var Client = /** @class */ (function () {
    function Client(opt, cbs) {
        var _this = this;
        this._des = new auth_1.DesTokenr();
        this._opt = opt;
        // console.log(addr, opt, cbs);
        var addr = opt.host + utils_1.addSlashLeft(opt.nspName);
        this._socket = socket_io_client_1.default(addr, opt);
        this._socket.on("logic/error", function () {
            var args = [];
    ...
    Client.prototype.sendInRoom = function (roomId, meta) {
        ...
        msg.evt = 'chat/rooms';
        var roomsMsg = new proto.RoomsMessage(this._opt.nspName, roomId, msg);
        try {
    ...
    Client.prototype.sendToUser = function (userId, meta) {
        var msg = new proto.Message(meta);
        msg.evt = "chat/users";
        var usersMsg = new proto.UsersMessage(this._opt.nspName, userId, msg);
        try {
